...
data = ["data/Test Run 1 synthetisch niks.txt",       0, 9.15,  9.14,  1.17;    %run 1
        ...
        "data/Test Run 5 1 vezel.txt",                0, 0.065, 0.064, 0.065;   %run 5
        "data/Test Run 8 verticaal 1.txt",            0, 0.95,  0.48,  0.22;    %run 6
        "data/Test Run 9 - 45 graden 1.txt",         45, 3.3,   1.64,  0.9;     %run 7
        "data/Test Run 8 horizontaal 1.txt",         90, 3.14,  3.03,  0.33;    %run 8
        "data/Test Run 9 verticaal 2.txt",            0, 4.76,  4.53,  0.91;    %run 9
        "data/Test Run 10 horizontaal 2.txt",        90, 2.24,  2.12,  0.59];   %run 10
